...
const builtInItems = [
    ...
    { id: 'wheyIsolate', name: 'Whey Isolate', category: 'breakfast', amount: 25, unit: 'gram' },
    { id: 'vitaminGummy', name: 'Multivitamin Gummy', category: 'breakfast', amount: 1, unit: 'piece' },
    { id: 'milk', name: 'Milk', category: 'breakfast', amount: 400, unit: 'gram' },
    { id: 'banana', name: 'Banana', category: 'breakfast', amount: 100, unit: 'gram' },

    // Lunch items
    { id: 'sweetPotato', name: 'Sweet Potato', category: 'lunch', amount: 200, unit: 'gram' },
    { id: 'milk', name: 'Milk', category: 'lunch', amount: 220, unit: 'gram' },
    ...
    { id: 'milk', name: 'Milk', category: 'dinner', amount: 200, unit: 'gram' },
    ...
    { id: 'milk', name: 'Milk', category: 'dessert', amount: 100, unit: 'gram' },
    { id: 'creatine', name: 'Creatine', category: 'dessert', amount: 5, unit: 'gram' },
    { id: 'ancientGrains', name: 'Ancient Grains', category: 'dessert', amount: 25, unit: 'gram' },
